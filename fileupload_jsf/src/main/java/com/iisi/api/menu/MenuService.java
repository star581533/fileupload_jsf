...
//	public static final String ADD_USER = "/pages/secure/addUser.xhtml?faces-redirect=true";
//	
//	public static final String FILE_DELETE = "/pages/secure/fileDelete.xhtml?faces-redirect=true";
//	
//	public static final String FILE_QUERY = "/pages/secure/fileQuery.xhtml?faces-redirect=true";
//	
//	public static final String FILE_UP_LOAD = "/pages/secure/fileUpload.xhtml?faces-redirect=true";
//	
//	public static final String LOGIN_LOG_QUERY = "/pages/secure/loginLogQuery.xhtml?faces-redirect=true";
//	
//	public static final String OPERATION_LOG_QUERY = "/pages/secure/operationLogQuery.xhtml?faces-redirect=true";
//	
//	public static final String QUERY_USER = "/pages/secure/queryUser.xhtml?faces-redirect=true";
//	
//	public static final String UPDATE_PWD = "/pages/secure/updatePwd.xhtml?faces-redirect=true";
//	
//	public static final String UPDATE_USER = "/pages/secure/updateUser.xhtml?faces-redirect=true";
//	
//	public static final String LOGIN = "/pages/unsecure/login.xhtml?faces-redirect=true";
//	
//	public static final String INDEX = "/pages/secure/index.xhtml?faces-redirect=true";
